    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[80vh] overflow-hidden">
        ...
        <div className="relative h-full  mx-auto px-4 flex flex-col justify-center">
          <h1 className="text-3xl md:text-4xl tracking-[0.06rem] font-bold text-white mb-6 animate-fade-in">
            Discover Amazing Destinations
          </h1>
          <p className="text-xl text-center text-gray-200  tracking-[0.06rem]  mb-8">
          ...
          <div className="flex justify-center gap-4">
            ...
            <button className="px-8 py-3 bg-white/10 text-white font-semibold rounded-lg hover:bg-white/20 transition-colors backdrop-blur-sm">
              View Packages
            </button>
          </div>
        </div>
          ...
          <div className="flex space-x-8 overflow-x-auto">
            {['destinations', 'packages', 'spots'].map((tab) => (
              <button
                ...
                className={`py-6 px-4 font-medium text-lg border-b-2 transition-colors ${
                  activeTab === tab
