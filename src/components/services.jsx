          ...
          {packages.map((pkg, index) => (
            ...
            >
              <div className="bg-[#facf2d87] p-6">
                <h3 className="text-xl font-semibold tracking-[0.05rem] mb-2">
                  {pkg.title}
                </h3>
                ...
                <ul className="space-y-3">
                  {pkg.features.map((feature, i) => (
                    <li key={i} className="flex items-center group">
                      ...
                      <span className="text-sm group-hover:text-[#FACF2D] transition-colors">
                        {feature}
                      </span>
                    </li>
                  ))}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {destinations.map((dest, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h4 className="text-xl font-semibold mb-3 group-hover:text-[#FACF2D] transition-colors">
                  {dest.city}
                </h4>
