...
import { Car, MapPin, Calendar, Clock, Plane, Users, BriefcaseIcon } from "lucide-react";
  ...
  const renderFormFields = () => {
      ...
      local: {
        hourly: (
          <div className="flex-1">
            ...
            <div className="relative">
              <select className="w-full py-3 border-b-2 text-sm tracking-[0.06rem] border-black bg-transparent focus:outline-none pl-8">
    ...
    return (
      <div className="flex flex-col lg:flex-row lg:items-end gap-6">
        ...
        {(tab === "outstation" || tab === "airport") && serviceType === "roundTrip" && additionalFields.outstation.roundTrip}
      </div>
    );
  };
    ...
    <div className="">
      ...
      <div className="w-full mx-auto p-6 bg-[#FFFCD1]">
        ...
        <div className="flex items-center justify-center mt-8">
          <button className="bg-black text-white rounded-md uppercase px-9 py-2 text-sm tracking-[0.06rem] hover:text-yellow-400 transition">
            Book Now!
          </button>
        </div>
      </div>
